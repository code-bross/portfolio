                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          border: Border(
                            bottom:
                                BorderSide(color: Colors.grey[800] ?? Colors.grey, width: 2.0),
                          ),
                        ),
                      ),
                      SizedBox(
                        ...
                        children: [
                          Padding(
                            ...
                            child: OutlinedCustomBtn(
                              onPressed: () {
                                html.window.open(host.resumeUrl, "pdf");
                              },
                              btnText: "Resume",
                            ),
                          ),
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border(
                                bottom: BorderSide(
                                    color: Colors.grey[900] ?? Colors.grey, width: 2.0),
                              ),
                            ),
                          ),
